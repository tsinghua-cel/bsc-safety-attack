...
This repository contains the code used to reproduce the four experiments presented in the paper “Be Careful about Validator Switch: A Safety Attack to Binance Smart Chain”: Attack 1, Attack 2, parameter-adjustment
